...
export default function(state = INITIAL_STATE, action) {
  ...
  switch(action.type) {
    ...
    return { ...state, auth_token: null, status:'signin', error:null, loading: true}; 
    case SIGNIN_USER_SUCCESS://return authenticated user,  make loading = false and status = authenticated
    return { ...state, user: action.payload.user, auth_token: action.payload.auth_token, status:'authenticated', error:null, loading: false}; //<-- authenticated
